...
l2= list.sort_by {|x| x.length}
puts "le handle le plus court de cette liste est: #{l2[0]}"
...
puts "dans la liste il y a #{compt} handle contenant 5 caractères"

#Combien commencent par une majuscule (première lettre juste après le @) ?
counter=0
    l2.length.times do |index|
        if l2[index][1]==l2[index][1].upcase 
            counter=counter+1
        end
    end
   
puts "dans la liste il y a : #{counter} qui commencent par une majuscule" 

#Trie la liste de handle par ordre alphabétique.
puts "voila la liste de handle par ordre alphabétique :"
puts list.sort 

#Trie la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)

puts "voici la liste de handle par taille des handle (les plus petits en premiers, les plus grands après)
 : "
puts l2

#Quelle est la position dans l'array de la personne @epenser ?

puts "la position dans l'array de la personne @epenser est de : "
...
puts "Desolé j'ai fait le maximum, smile. "
puts "fin."